/* 
This code is for the initial phase requirements, which involve fetching GPS data and handling SOS and OK interrupts, then sending the data through an HTTP POST request.
 */
